...
// DEADLINE = 2026-06-11T23:00:00.000Z (UTC)
// Equivale a: Chile (UTC-4) → 2026-06-11 19:00  (cierre de inscripción)
...
describe("isLocked", () => {
  ...
  describe("zonas horarias", () => {
    ...
    it("usuario en Chile (UTC-4): el momento exacto del deadline es el mismo timestamp", () => {
      // 2026-06-11 19:00 hora Chile = 2026-06-11T23:00Z
      const deadlineChile = Date.UTC(2026, 5, 11, 23, 0, 0); // +4h offset aplicado
    ...
    it("usuario en otra zona horaria: el momento exacto del deadline es el mismo timestamp", () => {
      ...
      const deadlineSeul = Date.UTC(2026, 5, 11, 23, 0, 0); // UTC es UTC, mismo valor
